...
<section class="category-carousel container mt-md-5"  data-aos="fade-up"
      ...
      <div class="swiper-container js-swiper-slider" data-settings='{
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/5.png') }}" width="124"
              height="124" alt="" />
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/6.png') }}" width="124"
              height="124" alt="" />
            <div class="text-center">
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/7.png') }}" width="124"
              height="124" alt="" />
            <div class="text-center">
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/8.png') }}" width="124"
              height="124" alt="" />
            <div class="text-center">
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/9.png') }}" width="124"
              height="124" alt="" />
            <div class="text-center">
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="w-100 h-auto mb-3" src="{{ asset('assets/images/10.png') }}" width="124"
              height="124" alt="" />
            <div class="text-center">
...
<br> <br> <br><br><br>
  ...
  <div class="container my-5 mt-5">
    <h2 class="text-center mb-4 pt-5 mb-5">Bento Grid Layout with Images</h2>
    <div class="row g-4">
        <!-- Large item -->
        <div class="col-md-8"  data-aos="fade-up"
        data-aos-anchor-placement="center-bottom">
            <div class="bento-item bento-tall">
                <img src="{{ asset('assets/images/layouts/3.jpg') }}" alt="Nature">
            ...
            <div class="row g-4">
                ...
                data-aos-anchor-placement="center-bottom">
                    <div class="bento-item">
                        <img src="{{ asset('assets/images/layouts/6.jpg') }}" alt="Food">
                        <div class="bento-content">
                ...
                data-aos-anchor-placement="center-bottom">
                    <div class="bento-item">
                        <img src="{{ asset('assets/images/layouts/2.webp') }}" alt="Technology">
                        <div class="bento-content">
        ...
        data-aos-anchor-placement="center-bottom">
            <div class="bento-item">
                <img src="{{ asset('assets/images/layouts/5.jfif') }}" alt="Travel">
                <div class="bento-content">
        ...
        data-aos-anchor-placement="center-bottom">
            <div class="bento-item">
                <img src="{{ asset('assets/images/layouts/4.jpg') }}" alt="Art">
                <div class="bento-content">
        ...
        data-aos-anchor-placement="center-bottom">
            <div class="bento-item">
                <img src="{{ asset('assets/images/layouts/7.webp') }}" alt="Sport">
                <div class="bento-content">
